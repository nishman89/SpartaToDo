...
namespace SpartaToDo.Controllers
{
    ...
    public class ToDoController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                toDos = await _service.GetToDoItemsAsync();
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var currentUser = await _userManager.GetUserAsync(HttpContext.User);
            if (toDo.SpartanId != currentUser.Id)
            {
                return NotFound();
            }
        ...
        [Authorize(Roles = "Trainee")]
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Complete")] ToDoViewModel toDoViewModel)
        {
            var currentUser = await _userManager.GetUserAsync(HttpContext.User);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            var toDo = await _service.GetToDoItemByIdAsync(id);
            var currentUser = await _userManager.GetUserAsync(HttpContext.User);
            if (toDo.SpartanId != currentUser.Id || id == null || toDo == null)
            {
                return NotFound();
            }
